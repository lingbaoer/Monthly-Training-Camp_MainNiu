...
namespace ShaderWeaver
{
	...
	public class SWShaderProcessCartoon:SWShaderProcessBase{
		public  SWShaderProcessCartoon():base()
		{
			type = SWNodeType.cartoon;
	...
	public class SWShaderProcessReceiveCartoon:SWShaderProcessReceiveBase{
		public SWShaderProcessReceiveCartoon():base()
		{
			type = SWNodeType.cartoon;
		}
