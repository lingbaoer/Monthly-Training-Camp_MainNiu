	...
	SubShader {   
		...
		Blend One OneMinusSrcAlpha
			...
			float4 frag (v2f i) : COLOR {
				...
				color_ROOT = Blur(_MainTex,uv_ROOT,float2( 1*_blurX*0.1 ,1*_blurY*0.1)*rect_ROOT.zw);
