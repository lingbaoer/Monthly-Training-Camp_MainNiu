	...
	SubShader {   
		...
		ColorMask [_ColorMask]
			...
			float4 frag (v2f i) : COLOR {
				...
				float4 color_image1 = tex2D(_button,uv_image1);    
				color_image1 = color_image1*_Color_image1;


				//====================================
				//============ remap3 ============   
				float2  uv_remap3 = uv_image1;    
